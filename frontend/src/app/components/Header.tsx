...
export function Header({ rightTopButton, titleButton, subTitle }: HeaderProps) {
  return (
    <div className="bg-white shadow-[0px_1px_6px_0px_rgba(0,0,0,0.16)] pb-4">
      <div className="flex items-center justify-between px-[8px] pt-[16px]">
      ...
      <div className="flex items-center px-[8px] mt-[12px]">
